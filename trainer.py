...
class Trainer(nn.Module):
    def __init__(self, conf):
        ...
        #0.0001
        self.lr_dis = conf['lr_dis']#判别器的学习率
        self.lr_gen = conf['lr_gen']#生成器的学习率
        #getattr用于返回对象的属性值
    ...
    def resume(self, checkpoint_dir):
        ...
        state_dict = torch.load(os.path.join(checkpoint_dir, 'optimizer'))
    ...
    def load_ckpt(self, ckpt_name):
        ...
        self.model.gen.load_state_dict(state_dict,strict=False)
        print('Load success')
    #生成
